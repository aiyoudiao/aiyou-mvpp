...
Macro.prototype.getArguments = function () {
  ...
  //   console.log ('打印args  开始*************************************');

  //   console.log (args);

  //   console.log ('打印args  结束*************************************');
...
MacroContext.prototype.resolveMacros = function (content, macros) {
  ...
  content = content.replace (regex, function (match) {
    ...
    // console.log (
    //   '打印macros[macro.name]  开始*************************************'
    // );
    // console.log (macro.name, macros[macro.name]);

    // console.log (
    //   '打印macros[macro.name]  结束*************************************'
    // );
    return (
      "' + " + macros[macro.name].apply (null, macro.getArguments ()) + " + '"
    );
  });
