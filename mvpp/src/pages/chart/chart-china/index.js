...
layui.use (['okUtils'], function () {
  ...
  function chinaChart1 () {
    ...
    // 初始化图表
    const chinaChart1 = echarts.init ($ ('#chinaChart1')[0]);
  ...
  function chinaChart2 () {
    ...
    const chinaChart2 = echarts.init ($ ('#chinaChart2')[0]);
  ...
  function chinaChart3 () {
    const chinaChart3 = echarts.init ($ ('#chinaChart3')[0]);
  ...
  function chinaChart4 () {
    ...
    const chinaChart4 = echarts.init ($ ('#chinaChart4')[0]);
