...
layui.use (
   ...
   */
    $ (
      'body'
    ).on ('click', '#navBar .layui-nav-item a, #userInfo a', function () {
      // 如果不存在子级
      ...
      if (!$ (this).attr ('lay-id')) {
        ...
        var childs = $ ('#navBar > li > dl.layui-nav-child').not (
          topLevelEle.children ('dl.layui-nav-child')
        );
